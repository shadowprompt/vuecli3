...
export default {
  ...
  watch: {
    value: {
      ...
      handler(value, oldVal) {
        console.log("handler -> ", oldVal);
        console.log("handler -> ", value);
        let newVal = value === undefined ? value : Number(value);
        // let newVal = value === undefined ? value : this.initial ? Number(value): value;
        console.log("value -> ", value, newVal, newVal !== undefined);
        if (newVal !== undefined) {
          if (isNaN(newVal)) {
            return;
          }
          ...
          // if (this.precision !== undefined && this.initial) {
          //   console.log('dad');
          //   newVal = this.toPrecision(newVal, this.precision);
          // }
        }
  ...
  methods: {
    ...
    handleInputChange(value) {
      // 根据emptyMin有改动
      const newVal =
        value === "" ? (this.emptyMin ? this.min : undefined) : Number(value);
