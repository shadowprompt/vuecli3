...
(OrgChart.prototype.load = function(t) {
  ...
  (OrgChart.prototype._draw = function(t, O, v, x) {
    ...
    this.server.read(
      ...
      function(t) {
        ...
        e = { content: r, res: t };
        if (
          (OrgChart.events.publish('render', [y, e]),
          (r = e.content),
          ...
          if (y._initialized) {
            ...
            (y.element.innerHTML =
              y.ui.css() + y.ui.exportMenuButton(y.config) + m),
          ...
          O === OrgChart.action.centerNode
            ...
            : !a ||
              !y.response ||
              (a[0] == y.response.viewBox[0] &&
                a[1] == y.response.viewBox[1] &&
                a[2] == y.response.viewBox[2] &&
                a[3] == y.response.viewBox[3]) ||
              (O !== OrgChart.action.insert &&
                O !== OrgChart.action.expandCollapse &&
                O !== OrgChart.action.update &&
            ...
            ? 0 == g[0].length &&
              (c ||
                (x && x(), OrgChart.events.publish('redraw', [y]), (c = !0)))
            : OrgChart.anim(
                y.getSvg(),
                { viewbox: a },
                { viewbox: y.response.viewBox },
            ...
            y._initialized ||
              ((y._initialized = !0), OrgChart.events.publish('init', [y]));
        } else {
          var f = t.boundary,
            u = f.maxX - f.minX,
            C = f.maxY - f.minY,
  ...
  (OrgChart.prototype._canUpdateLink = function(t, e) {
    return (
      null != e &&
      null != e &&
      null != t && null != t && t != e && !this.isChild(t, e)
    );
  }),
  ...
  (OrgChart.prototype._pagesAfit = function(t, e) {
    ...
    for (var C = l.h, m = g, O = p, v = []; O < u; ) {
      var x = [m, O * c, f, u];
      (x = x.join()),
        v.push({ vb: x, innerSize: l, size: s }),
        (O += l.h),
        i < (C += l.h) && (C = i);
    }
    return v;
    ...
    if (this.config.enableDragDrop) {
      ...
      if (!1 !== OrgChart.events.publish('drag', [this, i])) {
        ...
        var O = function(t, e) {
          ...
          x = function(t) {
            if (
              ...
              c.removeEventListener(n.up, x),
              n.leave && c.removeEventListener(n.leave, x),
              l.id == s ||
        ...
        c.addEventListener(n.move, v),
          c.addEventListener(n.up, x),
          n.leave && c.addEventListener(n.leave, x);
      }
    }
  }),
  ...
  (OrgChart.server._createNodes = function(a, t, e, r) {
      ...
      t == OrgChart.action.exporting && null != e.id && (l = [o[e.id]]),
        x
          ? ((v.state = x.state),
            ...
            OrgChart.server._setNodeGroupState(v, x.groupState, a.orientation))
    ...
    for (c = 0; c < s.length; c++) {
      ...
      if (H) {
        var k = new OrgChart.node(H.id + '_split_0', H.id, [], 'split');
        ((o[k.id] = k).isAssistant = !0),
          (x = r[k.id]) &&
            ((o[k.id].state = x.state),
            o[k.id].state == OrgChart.COLLAPSE && m.push(k.id)),
          OrgChart.server._initStates(k, o, t, a, e, m);
        var _ = [];
        for (b = H.children.length - 1; 0 <= b; b--) {
          (U = H.children[b]).isAssistant
            ? ((U.parent = null),
              ...
              _.splice(0, 0, U.id))
            : ((U.pid = k.id),
              (U.parent = k).children.unshift(U),
              k.childrenIds.unshift(U.id),
              H.children.splice(b, 1));
        }
        if (_.length % 2) {
          var A = o[_[_.length - 1]],
            S = [A.w, A.h],
          ...
          (OrgChart.templates[I] = {
            ...
            (x = r[(o[W.id] = W).id]) &&
              ((o[W.id].state = x.state),
              o[W.id].state == OrgChart.COLLAPSE &&
                -1 == m.indexOf(W.id) &&
                m.push(W.id)),
            _.splice(_.length - 1, 0, W.id),
            OrgChart.server._initStates(W, o, t, a, e, m);
        }
        var N = 1;
        for (b = _.length - 1; 0 <= b; b--) {
          if (b % 2 && b != _.length - 1)
            ((J = new OrgChart.node(
              H.id + '_split_' + N,
              null,
        ...
        for (b = 0; b < _.length; b += 3) {
          ...
          (x = r[L.id]) &&
            ((o[L.id].state = x.state),
            o[L.id].state == OrgChart.COLLAPSE &&
              -1 == m.indexOf(L.id) &&
              m.push(L.id)),
        ...
        for (c = 0; c < P.childrenIds.length; c++) {
          if (
            ...
            for (b = 0; b < U.childrenIds.length; b++) {
              var D,
                G = o[U.childrenIds[b]];
              -1 == (D = m.indexOf(U.childrenIds[b])) &&
                m.push(U.childrenIds[b]),
          ...
          if (H.children[b] == v)
            if (
              ...
              if ((M = v.parent)) {
                ...
                for (var R = M.childrenIds.length - 1; 0 <= R; R--) {
                  var X = M.childrenIds[R];
                  -1 == M.collapsedChildrenIds.indexOf(X) &&
                    M.collapsedChildrenIds.push(X);
                }
              }
            } else v.parent = null;
        }
    ...
    if (
      ...
      for (c = 0; c < q.length; c++) {
        (H = o[q[c]]),
          (k = new OrgChart.node(H.id + '_split_0', H.id, [], 'split'));
        (o[k.id] = k).layout = OrgChart.tree;
        var V = [];
        for (b = H.children.length - 1; 0 <= b; b--) {
          if (OrgChart.server._mixedLayoutAllNodes(H))
            if (
              0 == (U = H.children[b]).childrenIds.length &&
              !U.isAssistant &&
              'split' != U.templateName &&
  ...
  (OrgChart.server._getResponse = function(
    ...
    if (
      ...
      if (b - 2 * i.padding >= o - l)
        switch (((k = (o + l) / 2 - b / 2), i.orientation)) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            k = (l - o) / 2 - b / 2;
        }
        ...
        switch (
          ((k = -(b / 2 - (o - l) / 2)) > -i.padding && (k = -i.padding),
          i.orientation)
        ) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (k = -(b / 2 - (l - o) / 2)) < i.padding - b && (k = i.padding - b);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.right:
            k = h.y - b / 2 + OrgChart.server._getNodeWidth(h, i) / 2;
        }
      s = [w, k, y, b];
    } else if (null == s && i.align == OrgChart.ORIENTATION) {
      (y = Math.ceil(t / x)), (b = Math.ceil(e / x)), (w = 0), (k = 0);
    ...
    if (
      ...
      if (
        ...
        (_ = g[c.insertedNodeId]) || (_ = g[p[c.insertedNodeId]]);
      else if (
        d == OrgChart.action.update &&
        c &&
        null != c.visId &&
        ...
        (_ = g[c.id]) || (_ = g[p[c.id]]),
          (_ = OrgChart.server._getMostDeepChild(_, g));
        ...
        switch (i.orientation) {
          ...
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            c.options.vertical || (_ = g[c.id]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            c.options.horizontal || (_ = g[c.id]);
        }
        _ &&
          (_ || (_ = g[p[c.id]]),
          (_ = OrgChart.server._getMostDeepChild(_, g)));
      ...
      if (OrgChart.server._isVisible(I, i, s, d)) {
        ...
        if (
          ...
          if (
            ...
            (M = I.parent) &&
              M.id == c.id &&
              (N = { x: B.x + B.w / 2 - I.w / 2, y: B.y + B.h / 2 - I.h / 2 });
    ...
    if ('multiline' == s) {
      ...
      for (var O = 1, v = 1; v < f.length; v++) {
        ...
        if (
          ...
          if (
            ((C.firstChild.data = C.firstChild.data.slice(0, x)),
            O++,
            0 !== c && c < O)
          )
            break;
  ...
  (OrgChart.collapsedChildrenCount = function(t, e, r) {
    ...
    for (var a = 0; a < i.length; a++) {
      ...
      'string' == typeof o &&
      -1 == o.indexOf('split') &&
      -1 == o.indexOf('transperant')
        ? -1 == r.indexOf(o) && r.push(o)
        : 'string' != typeof o && -1 == r.indexOf(o) && r.push(o),
    ...
    for (var r, i, a, o, n, l = '', s = 0; s < this.config.clinks.length; s++) {
      ...
      if (
        ...
        switch (this.config.orientation) {
          ...
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (O.x = x <= y ? ((k = -1), x + d.w / 10) : ((k = 1), x - d.w / 10)),
              (v.x = y + c.w / 10),
              p == u
                ? ((k = -1), (O.y = p + d.h), (v.y = u + c.h))
                : u < p
                ? ((O.y = p), (v.y = u + c.h))
                : ((O.y = p + d.h), (v.y = u));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            (O.y = b <= w ? ((k = -1), b + d.h / 5) : ((k = 1), b - d.h / 5)),
              (v.y = w + c.h / 5),
              g == f
                ? ((k = -1), (O.x = g), (v.x = f))
                : f < g
  ...
  (OrgChart.prototype._slinks = function(k, _) {
    var A = '',
      S = this.getScale(),
      I = _.res.boundary;
    function t(t, e, r) {
      ...
      if (t.level == e.level)
        switch (((a = e), k.config.orientation)) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            i.push([s.p, s.q]),
              i.push([s.p, s.q - l / 3]),
        ...
        for (var h = t; null == a; ) {
          ...
          if (
            (c.id == e.id
              ? (a = c)
              : OrgChart._intersects(c, s, k.config) &&
                ((s = OrgChart._addPoint(c, i, k.config, s, o)), (d = !0)),
            c.id != e.id)
          ) {
            for (; g; ) {
              if (g.id == e.id) {
              ...
              OrgChart._intersects(g, s, k.config) &&
                ((s = OrgChart._addPoint(g, i, k.config, s, o)), (d = !0)),
                (g = g.leftNeighbor);
            }
            for (; p; ) {
              if (p.id == e.id) {
              ...
              OrgChart._intersects(p, s, k.config) &&
                ((s = OrgChart._addPoint(p, i, k.config, s, o)), (d = !0)),
                (p = p.rightNeighbor);
            }
          }
          if (!d) {
      ...
      if (
        ((A +=
          '<g c-link-from="{from}" c-link-to="{to}">'
            .replace('{from}', t.id)
            .replace('{to}', e.id) + n.link.replaceAll('{d}', x)),
        N.label)
      ) {
        var y = n.label
            .replace('{x}', m.x)
      ...
      (A += OrgChart.grCloseTag), (_.content += A);
    }
    for (var e = 0; e < this.config.slinks.length; e++) {
      var N = this.config.slinks[e];
      if (_.res.visibleNodes[N.from] && _.res.visibleNodes[N.to]) {
        var r = k.getBGNode(N.from),
          i = k.getBGNode(N.to);
